...
This creates a Python virtual environment at `.claude/skills/nano-banana-image-editor/.venv/` and installs the required packages (google-genai, Pillow).

**API Key Setup:**

1. Get an API key from [Google AI Studio](https://aistudio.google.com/app/apikey)
2. **Run the setup script** to save the key:

   ```bash
   .claude/skills/nano-banana-image-editor/.venv/bin/python3 .claude/skills/nano-banana-image-editor/scripts/setup-gemini-token.py YOUR_API_KEY
   ```

   The script will:
   - Test the API key to verify it works
   - Save it to `.claude/.nano-banana-config.json`
   - Confirm that Gemini 3 Pro Image model is available

All script examples below use `.claude/skills/nano-banana-image-editor/.venv/bin/python3` to ensure the venv's Python interpreter is used.
...
```bash
.claude/skills/nano-banana-image-editor/.venv/bin/python3 .claude/skills/nano-banana-image-editor/scripts/create_image.py \
...
```bash
.claude/skills/nano-banana-image-editor/.venv/bin/python3 .claude/skills/nano-banana-image-editor/scripts/edit_image.py \
...
- Run the setup script: `.claude/skills/nano-banana-image-editor/.venv/bin/python3 .claude/skills/nano-banana-image-editor/scripts/setup-gemini-token.py YOUR_API_KEY`
...
.claude/skills/nano-banana-image-editor/.venv/bin/python3 .claude/skills/nano-banana-image-editor/scripts/quick_crop.py \

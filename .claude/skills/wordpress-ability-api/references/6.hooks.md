...
Fires when the abilities registry is initialized. This is the proper hook to use when registering abilities.
 ...
 * Register abilities.
 *
 * @param \WP_Abilities_Registry $registry The abilities registry instance.
 */
function my_plugin_register_abilities( $registry ) {
    wp_register_ability( 'my-plugin/get-site-info', array(
        'label'            => __( 'Get Site Info', 'my-plugin' ),
        'description'      => __( 'Retrieves site information.', 'my-plugin' ),

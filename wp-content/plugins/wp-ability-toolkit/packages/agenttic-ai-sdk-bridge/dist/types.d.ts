 ...
 */
import type { UIMessage as AgentticUIMessage, Suggestion as AgentticSuggestion } from '@automattic/agenttic-client';
import type { MessageAction } from '@automattic/agenttic-ui';
import type { Ability, AbilityInput, AbilityOutput } from '@wordpress/abilities';
 ...
 */
export type ClientAbility = Pick<Ability, 'name' | 'label' | 'description' | 'category' | 'input_schema' | 'output_schema'>;
...
export interface UseWordPressChatReturn {
    ...
    continueWithToolResult: (assistantMessage: WordPressMessage, toolResult: WordPressMessage) => Promise<void>;

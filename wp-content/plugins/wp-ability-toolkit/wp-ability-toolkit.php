...
// Check if Abilities API is available (requires WordPress 6.9+).
if ( ! class_exists( 'WP_Ability' ) ) {
	add_action(
		'admin_notices',
		function () {
			echo '<div class="notice notice-error"><p>';
			esc_html_e( 'AI Ability Toolkit requires WordPress 6.9 or later with the Abilities API.', 'wp-ability-toolkit' );
			echo '</p></div>';
		}
	);
	return;

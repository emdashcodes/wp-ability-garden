...
class Settings {
	...
	public function sanitize_provider( string $value ): string {
		$valid_providers = array( 'openai', 'anthropic' );
		return in_array( $value, $valid_providers, true ) ? $value : 'anthropic';
	}
	 ...
	 *
	 * @return string Provider ('anthropic' or 'openai').
	 */
	public function get_provider(): string {
		return get_option( self::OPTION_PROVIDER, 'anthropic' );
	}
	...
	public function get_model(): string {
		return get_option( self::OPTION_MODEL, 'claude-sonnet-4-5-20250929' );
	}
}
